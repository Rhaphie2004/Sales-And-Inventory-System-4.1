...
{
    public partial class Stock_Deleted : Form
    {
        public Stock_Deleted()
        {
            InitializeComponent();
        }
        ...
        private Stock_Deleted.enmAction action;
        private int x, y;
        ...
        public void showalert(string msg)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Stock_Deleted frm = (Stock_Deleted)Application.OpenForms[fname];
