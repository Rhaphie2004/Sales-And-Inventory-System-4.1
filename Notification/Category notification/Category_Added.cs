...
{
    public partial class Category_Added : Form
    {
        public Category_Added()
        {
            InitializeComponent();
        }
        ...
        private Category_Added.enmAction action;
        private int x, y;
        ...
        public void showalert(string msg)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Category_Added frm = (Category_Added)Application.OpenForms[fname];
