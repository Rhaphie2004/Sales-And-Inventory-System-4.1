...
{
    public partial class Category_Deleted : Form
    {
        public Category_Deleted()
        {
            InitializeComponent();
        }
        ...
        private Category_Deleted.enmAction action;
        private int x, y;
        ...
        public void showalert(string msg)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Category_Deleted frm = (Category_Deleted)Application.OpenForms[fname];
