...
{
    public partial class Item_Added : Form
    {
        public Item_Added()
        {
            InitializeComponent();
        ...
        private Item_Added.enmAction action;
        private int x, y;
        ...
        public void showalert(string msg)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Item_Added frm = (Item_Added)Application.OpenForms[fname];
        ...
        private void Item_Added_Load(object sender, EventArgs e)
        {
